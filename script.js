...
if(average>=passingGrade){
    console.log(`${studentFirstName} ${studentLastName} has passed with an average grade of ${average}.`);
} else{
    console.log(`${studentFirstName} ${studentLastName} has not passed with an average grade of ${average}.`);
}